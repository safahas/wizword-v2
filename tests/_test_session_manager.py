...
def test_leaderboard(local_session_manager):
    games = [
        {"session_id": "test_1", "score": 10, "mode": "Wiz", "game_over": True, "word": "mouse"},
        {"session_id": "test_2", "score": 20, "mode": "Wiz", "game_over": True, "word": "horse"},
        {"session_id": "test_3", "score": 5, "mode": "Wiz", "game_over": True, "word": "koala"},
    ]
    ...
    assert leaderboard[0]["score"] == 5  # Best score in Wiz mode is lowest
